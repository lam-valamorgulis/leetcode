...
# note:
# how to loop from last to first in python

# how to solve:
# + create a HT to cal and store the nums-frequency (key-val)
# + problem: some key have same frequency => creat a fT frequency-listOfNumSameFreq
